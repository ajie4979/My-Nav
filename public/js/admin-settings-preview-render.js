(function () {
 ...
 function readPreviewSettings() {
    ...
    return {
      ...
      siteName: shared.getPreviewInputValueOrDefault(refs.homeSiteNameInput, current.home_site_name, '简读记忆'),
      siteDescription: shared.getPreviewInputValueOrDefault(refs.homeSiteDescriptionInput, current.home_site_description, '一个优雅、快速、易于部署的书签收藏与博客平台'),
