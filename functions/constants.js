...
export const SCHEMA_VERSION = 'v11';

// 上一个数据库 Schema 版本 - 仅用于首次迁移成功后 best-effort 清理旧迁移标记
export const PREVIOUS_SCHEMA_VERSION = 'v10';

// 首页 HTML 缓存版本 - 修改此值会强制刷新首页缓存
export const HOME_CACHE_VERSION = 'v41';

// “常用导航（加星）”虚拟分类：不是 category 表中的真实分类，而是聚合 is_star=1 的书签
export const STARRED_CATALOG_ID = 'starred';
export const STARRED_CATALOG_NAME = '常用导航';
...
CREATE INDEX IF NOT EXISTS idx_musics_active ON musics(is_active, sort_order);
